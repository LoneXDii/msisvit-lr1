...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.parse_button.setMinimumWidth(300)
        ...
        self.hLabel.setMinimumWidth(300)
    ...
    def on_parse_clicked(self):
        ...
        max_depth, count, operands, operators = parse_file(self.file_path)
